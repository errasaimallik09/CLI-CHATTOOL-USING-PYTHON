...
groups = {}#no of groups in the room
...
class Group:
    def __init__(self, admin, client):
        ...
        #join requests in the grp
        self.joinRequests = set()
        self.waitClients = {}#waiting clients list
...
#to accept incoming user by admin chat list
def pyconChat(client, username, groupname):
    while True:
        ...
        if msg == "/viewRequests":
            ...
            #when incoming user waits and disonnect
